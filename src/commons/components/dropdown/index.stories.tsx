...
const meta: Meta<typeof Dropdown> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '다양한 옵션을 선택할 수 있는 드롭다운 컴포넌트입니다.',
      },
    },
  },
  argTypes: {
...
const optionsWithDisabled: DropdownOption[] = [
  ...
  { value: 'option4', label: '활성 옵션 4' },
  { value: 'option5', label: '비활성 옵션 5', disabled: true },
];
